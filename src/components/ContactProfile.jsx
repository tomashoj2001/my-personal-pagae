export default function ContactProfile() {
  return (
    <section className="profiles">
      ...
      <a href="https://www.linkedin.com/in/tom%C3%A1s-hojnadel-83495b249/" target="_blank">
      ...
      <a href="https://api.whatsapp.com/send?phone=5493541317326" target="_blank">
        <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-brand-whatsapp" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
          <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
